...
const NotificationCard: React.FC<{
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'stock_alert': return 'bg-yellow-100 border-yellow-200'
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-start space-x-3 flex-1">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* WhatsApp button for stock alerts */}
            {notification.type === 'stock_alert' && (
              <div className="mt-3">
                <a
                  href={`https://api.whatsapp.com/message/VLVM27HUDJIEJ1?autoload=1&app_absent=0&text=Olá! Gostaria de comprar mais ${notification.message.split(' ')[0] || 'alimento para pet'}. Vi pelo app que está acabando.`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-2 bg-green-500 text-white px-3 py-1.5 rounded-full text-sm hover:bg-green-600 transition-colors"
                >
