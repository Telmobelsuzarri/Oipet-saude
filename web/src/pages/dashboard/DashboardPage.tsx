...
export const DashboardPage: React.FC = () => {
  ...
  const [showFoodScannerModal, setShowFoodScannerModal] = React.useState(false)
              ...
              {pets.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <button 
                    ...
                    className="bg-gradient-to-r from-coral-500 to-coral-600 text-white px-6 py-2 rounded-glass font-medium hover:from-coral-600 hover:to-coral-700 transition-all duration-200"
                  >
                    Adicionar Pet
                  </button>
                </div>
        ...
        <GlassCard>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => setShowFoodScannerModal(true)}
              className="flex flex-col items-center p-4 bg-white/30 rounded-glass border border-white/20 hover:bg-white/40 transition-all duration-200"
            >
